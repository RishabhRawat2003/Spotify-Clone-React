        ...
        <div className='w-full h-auto mt-5 px-3 flex flex-wrap justify-center lg:gap-3 xl:justify-around'>
            {
                data && data.length > 1
                    ? data.map((items) => (
                        <Link className='h-52 w-40 bg-slate-900 mx-1 my-1 flex flex-col hover:opacity-70 duration-200 rounded-md md:w-56 md:h-72 lg:w-60 xl:w-80 xl:h-[330px]' key={items.id}>
