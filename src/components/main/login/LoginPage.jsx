            ...
            <div className='w-full h-auto bg-[#121212] md:bg-gray-950 md:py-14'>
                <div className='w-full h-auto flex flex-col md:w-[700px] md:mx-auto md:bg-[#121212] rounded-xl'>
                    ...
                    <div className='w-[85%] h-auto flex flex-col mx-auto mt-10'>
                        <p className='w-full h-12 my-1 flex justify-center items-center border-[1px] border-gray-500 rounded-full cursor-default hover:border-white relative md:w-[60%] mx-auto'>
                        ...
                        <p className='w-full h-12 my-1 flex justify-center items-center border-[1px] border-gray-500 rounded-full cursor-default hover:border-white md:w-[60%] mx-auto'>
                    ...
                    <div className='w-full h-auto flex flex-col px-8 md:w-[55%] mx-auto'>
                        ...
                        <div className='w-full h-auto flex flex-col justify-center items-center mb-24'>
                            <p className='text-white underline hover:text-green-500 cursor-pointer'>Forgot your password?</p>
                            <p className='text-gray-500 my-3'>Don't have an account?</p>
                            <p className='text-white underline hover:text-green-500 cursor-pointer'>Sign up for Spotify</p>
                        </div>
                    </div>
                </div>
