            ...
            data && data.length >= 1
              ? data.map((items) => (
                items.track.preview_url ?
                  <div key={items.track.id} id={items.track.id} className='group h-16 w-full flex justify-between my-2 bg-slate-900 active:bg-slate-800 select-none md:hover:bg-slate-800 duration-200 cursor-pointer relative rounded-md lg:h-20'>
