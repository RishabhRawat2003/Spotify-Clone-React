        ...
        <>
            <div className='h-16 w-full flex justify-end items-center rounded-t-md sm:h-20'>
                <div className='w-[350px] mx-auto h-full flex justify-between items-center sm:mx-4 sm:w-auto sm:gap-3'>
                    <div className='w-32 h-8 text-sm font-semibold bg-white rounded-full text-black flex justify-center cursor-pointer items-center active:scale-105 md:hover:scale-105 md:duration-300 sm:h-10 sm:w-36 lg:h-12 lg:w-44 lg:text-base'>
                        Explore Premium
                    </div>
                    <Link to='https://www.spotify.com/in-en/download/windows/'>
                        <div className='w-32 h-8 text-sm font-semibold bg-black rounded-full text-white flex justify-center cursor-pointer items-center active:scale-105 md:hover:scale-105 md:duration-300 sm:h-10 sm:gap-2 sm:w-36 lg:h-12 lg:w-44 lg:text-base'>
