    ...
    if (user.length > 2) {
        ...
        return (
            <div className={toggle ? 'library bg-[#121212] h-[334px] w-[170px] mx-auto mt-1 rounded-lg flex flex-col justify-start items-center border-[1px] border-slate-500 gap-2 overflow-y-scroll' : 'library bg-[#121212] h-full w-16 mx-auto mt-1 rounded-lg flex flex-col justify-start items-center border-[1px] border-slate-500 overflow-y-scroll gap-2 md:border-none md:w-full'}>
                ...
                {
                    toggle
                        ? <div className='w-[95%] h-36 bg-gray-800 flex flex-col rounded-lg select-none'>
                            <p className='text-base font-semibold text-white mx-3 my-1'>Create your first Playlist</p>
                            <p className='text-xs mx-3 text-white my-1'>it's easy, we'll help you</p>
                            <p className='text-xs mx-3 w-28 font-bold rounded-full text-black cursor-pointer p-2 flex items-center justify-center bg-white my-2 hover:scale-105'>Create playlist</p>
                        </div>
                        : <div className='w-[95%] h-36 bg-gray-800 hidden flex-col my-2 rounded-lg select-none md:flex'>
                            <p className='text-lg font-semibold text-white mx-3 mt-2'>Create your first Playlist</p>
                            <p className='text-sm mx-3 text-white my-1'>it's easy, we'll help you</p>
                            <Link to='login' className='text-sm mx-3 w-36 font-bold rounded-full text-black cursor-pointer p-2 flex items-center justify-center bg-white mt-4 hover:scale-105'>Create playlist</Link>
                        </div>
                }
            </div>
        )
